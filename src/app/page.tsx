  ...
  return (
    <div className="bg-gray-100 text-gray-900 font-sans p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mt-2">Notion GitHub Tracker is a dynamic Next.js application designed to seamlessly integrate GitHub user data into Notion. This tool offers a convenient way to track and display GitHub contributions directly within a Notion page.</p>
        ...
        <pre className="bg-gray-200 text-gray-700 p-4 rounded"><code>npm run dev
          # or
          yarn dev
          # or
          pnpm dev
        ...
        <p className="mt-2">Visit <a href="http://localhost:3000" className="text-blue-500 hover:text-blue-700">http://localhost:3000</a> in your browser to view the application.</p>
        ...
        <p className="mt-2">The project allows users to view GitHub contribution data directly on Notion. Follow these steps to use it:</p>
        <ol className="list-decimal list-inside ml-6">
          <li>Navigate to the deployed URL: <a href="https://notion-github.vercel.app/:username?theme=dark" className="text-blue-500 hover:text-blue-700">https://notion-github.vercel.app/:username?theme=dark</a>.</li>
          <li>Replace <code>:username</code> with your GitHub username.</li>
          <li>Choose the theme by setting <code>theme=dark</code> or <code>theme=light</code> in the URL.</li>
        </ol>
        ...
        <ol className="list-decimal list-inside ml-6">
          ...
          <li>Set the URL to the deployed project URL with your GitHub username.</li>
          <li>Adjust the size of the embed block as needed.</li>
        </ol>

        <h2 className="text-2xl font-semibold mt-6">Contributing</h2>
        <p className="mt-2">Contributions to improve Notion GitHub Tracker are welcome. Feel free to fork the repository, make changes, and submit a pull request.</p>
        ...
        <p className="mt-2"><a href="https://github.com/kossakovsky/notion-github-graph/blob/main/LICENSE" className="text-blue-500 hover:text-blue-700">MIT</a></p>

        <h2 className="text-2xl font-semibold mt-6">Contact</h2>
        <p className="mt-2">For any queries or collaboration, please reach out to <a href="https://t.me/kossakovsky" className="text-blue-500 hover:text-blue-700">https://t.me/kossakovsky</a></p>
      </div>
    </div>
  )
}
